...
function GetSummaryData() {
    ...
    $.ajax({
        type: "GET",
        url: document.baseURI + "/SLLTAssessments/GetSummary",
        data: '',
            ...
            if (resp.IsSuccess) {
                ...
                for (var i = 0; i < resD.length; i++) {
                   ...
                   /* if (isdist == 0) {*/
                    ...
                    DistName.push(resD[i].QuestionCode + '. ' + resD[i].Question);
                        //TAns = resD[i].Ans*100/
                ...
                DataList.push({ name: 'Incorrect', data: PIncorrect, color: '#FF0000', y: TIncorrect })
